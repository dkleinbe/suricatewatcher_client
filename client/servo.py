...
class Servo:
    def __init__(self):
        ...
        self.PwmServo.setServoPulse(8, 1500) # Servo 0 - Position "0" (1.5 ms pulse)
        self.PwmServo.setServoPulse(9, 1500) # Servo 1 - Position "0" (1.5 ms pulse)

    def setServoPwm(self, channel, angle, error=10):

        logger.debug('+ setServoPwm channel %s angle %f', channel, angle)
